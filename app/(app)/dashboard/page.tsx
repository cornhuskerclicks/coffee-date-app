...
export default async function DashboardPage() {
  ...
  const { data: androidsData } = await supabase
    .from("androids")
    .select("id")
    .eq("user_id", user.id)
  ...
  return (
    <div className="p-8 space-y-8 max-w-7xl mx-auto bg-black">
      ...
      {(demosCount > 0 || ghlAccountCount > 0 || quizzesCount > 0) ? (
        <section className="space-y-4">
          ...
          <Card className="border border-white/10 bg-card">
            <CardContent className="p-8 text-center space-y-4">
              ...
              <p className="text-[15px] text-white/60 max-w-md mx-auto">
                Get started by creating your first Coffee Date demo, connecting a GHL account, or building an AI quiz for your clients.
              </p>
